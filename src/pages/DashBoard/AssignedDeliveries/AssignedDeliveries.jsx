...
const AssignedDeliveries = () => {
    ...
    return (
        <div className='shadow-xl bg-gray-100 rounded-2xl p-5 py-10 md:p-10 w-11/12 mx-auto mt-8'>
            <h1 className='text-3xl md:text-5xl text-center font-extrabold text-secondary mb-5'>Pending Pickups : {parcels.length}</h1>
                    ...
                    <tbody className='text-center'>

                        {
                            parcels.map((parcel, index) => <tr key={parcel._id}>
                                ...
                                <td>
                                    <button onClick={() => handleDeliveryStatusUpdate(parcel, 'parcel_picked_up')} className='btn btn-primary text-black mr-2'>Mark As Pick up</button>
